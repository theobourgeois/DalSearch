...
export function Schedule({ course }: { course: Course }) {
  ...
  const classColors = useMemo(() => {
    return course.termClasses.reduce(
      (acc, termClass, index) => {
        ...
        {course.termClasses
          ...
          .map((termClass) => {
            ...
            const bgColor = isSelected
              ? classColors[termClass.section + termClass.term] + "80"
              : "";
...
export function ScheduleCourse({
  ...
  const conflictIndex = termClasses.findIndex((otherClass, otherIndex) => {
    ...
    if (otherClass.days.includes(day) && otherClass.term === termClass.term) {
      return (
        ...
        <TooltipTrigger asChild>
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle>
                  {course} {termClass.type} {termClass.section} Details
                </DialogTitle>
